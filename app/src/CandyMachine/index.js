...
const CandyMachine = ({ walletAddress }) => {
  ...
  const renderMintedItems = () => (
    <div className="gif-container">
      <p className="gif-grid-title ">✨ ✨ ✨ Minted Items ✨ ✨ ✨</p>
  ...
  const renderDropTimer = () => {
    ...
    return <p className="drop-date">{`Drop Date: ${machineStats.goLiveDateTimeString}`}</p>;
  };
  ...
  return (
    ...
    machineStats && (
      <div className="machine-container">
        ...
        {renderDropTimer()}
        <div className="dashedBordered">
          <p className="mintTitle">NFTs Minted:</p>
          <p className="mintLabelNumber">{machineStats.itemsRedeemed}<span className="smallerCount">/{machineStats.itemsAvailable}</span></p>
        </div>

        {/* Check to see if these properties are equal! */}
        {machineStats.itemsRedeemed === machineStats.itemsAvailable ? (
          <h1 className="header linear-wipe">Sold Out</h1>
        ) : (
        ...
        {isLoadingMints && <p className="loading-mints">loading minted NFTs...</p>}
